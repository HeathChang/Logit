  ...
  return (
    <section className="w-full max-w-sm rounded-2xl border border-border-main bg-bg-card px-6 py-8 shadow-sm">
      <header className="mb-6">
        ...
        <p className="mt-1 text-xs text-text-sub">{t("login.description")}</p>
      </header>
      ...
      <form className="flex flex-col gap-4">
        ...
        <Button className="mt-1 h-9 rounded-lg border border-border-main bg-bg-main text-xs font-medium text-text-main transition-colors hover:border-logit-git hover:text-logit-git">
